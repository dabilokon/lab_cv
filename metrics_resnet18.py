...
# ---------- 1. Завантаження моделі ResNet-18 ----------

model_path = "resnet18.pth"    # файл з вагами після train_resnet18.py
model = ResNet18_Custom(num_classes=2, pretrained=False)  # pretrained=False, бо вантажимо свої ваги
...
print("\nМЕТРИКИ ДЛЯ МОДЕЛІ ResNet-18 (клас 'blocked' як позитивний):")
...
plt.title("Додаткові метрики ефективності моделі ResNet-18")
plt.ylabel("Значення (у відповідних одиницях)")
plt.grid(axis="y", linestyle="--", alpha=0.5)

# цифри трохи нижче вершини стовпчика, щоб не залазили на підпис
...
plt.title("ROC Curve for class 'blocked' (ResNet-18)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.ylim(0, 1.0)
plt.title("Основні метрики ResNet-18")
plt.ylabel("Значення")
